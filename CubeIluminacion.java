...
public class CubeIluminacion implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        canvas.addGLEventListener(new CubeIluminacion());
        frame.add(canvas);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glEnable(GL.GL_LIGHTING);//Se habilita la iluminación
        gl.glEnable(GL.GL_LIGHT0);//primera luz individualmente
        
        float[] luzAmbiente = {0.5f, 0.5f, 0.5f, 1.0f};
	float[] luzDifusa = {1.0f, 1.0f, 1.0f, 1.0f};
	float[] luzPosicion = {1.0f, 0.0f, 0.0f, 1.0f};
        float[] luzDireccion = {0.0f, 0.0f, -1.0f, 1.0f};
                        
//        gl.glLightfv(GL.GL_LIGHT0, GL.GL_AMBIENT, luzAmbiente, 0);
        gl.glLightfv(GL.GL_LIGHT0, GL.GL_DIFFUSE, luzDifusa, 0);
        gl.glLightfv(GL.GL_LIGHT0, GL.GL_POSITION, luzPosicion, 0);
        
        gl.glShadeModel(GL.GL_SMOOTH);

        gl.glEnable(GL.GL_COLOR_MATERIAL);//Implementar la definición de materiales
        
        gl.glMaterialfv(GL.GL_FRONT_AND_BACK, GL.GL_DIFFUSE, luzDifusa,0);
//	gl.glMaterialfv(GL.GL_FRONT, GL.GL_AMBIENT, luzAmbiente,0);
